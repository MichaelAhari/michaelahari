    ...
    $scope.hpItems = [
        {
            ...
            'expanded' : false,
            'img' : 'static/hacktheburgh2016.jpg',
        ...
        },
        {
            ...
            'content' : $sce.trustAsHtml(
                ...
                '<p>Our team was awarded 1st place, meaning that (hopefully) the code would be taken forward and worked on by JPM staff in the future</p>')
        },
        {
            'id':3,
            'title' : 'Hack The Burgh 2015',
            'expanded' : false,
            'img' : 'static/hacktheburgh2015.jpg',
            'sm' : 'static/placeholder-sm.jpg',
            'content' : $sce.trustAsHtml(
                ...
                '<p>Overall, our experience with Twilio was fun and I can confirm they have awesome t-shirts!. However, we used Java which I would absolutely not advise for using Twilio at a hackathon - use Javascript or Python instead!</p>')
        }
    ];
